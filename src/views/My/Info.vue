<template>
  <div class="info">
    ...
    <van-popup v-model="birthShow" position="bottom" :style="{ height: '40%' }">
      <van-datetime-picker v-model="currentDate" type="date" :min-date="minDate" :max-date="maxDate" @confirm="birthShow = false" @cancel="birthShow = false" />
    </van-popup>
  </div>
</template>
